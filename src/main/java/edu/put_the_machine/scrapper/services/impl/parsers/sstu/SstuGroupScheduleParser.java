...
public class SstuGroupScheduleParser {
    ...
    public SstuGroupScheduleParser(UrlToPageResolver urlToPageResolver, String instituteName) {
...
//        return getScheduleDaysFromColumns(scheduleCols);
    ...
    private List<ScheduleDayDto> getScheduleDaysFromColumns(Elements scheduleCols) {
        ...
        for (Element col : scheduleCols) {
            LocalDate date = getDateByColumn(col, currentYear);
    ...
    private LocalDate getDateByColumn(Element col, int currentYear) throws ParserException {
        String rawDate = getRawDate(col, currentYear);
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd.MM.yyyy");
        return LocalDate.parse(rawDate, formatter);
    }
    private String getRawDate(Element col, int currentYear) {
